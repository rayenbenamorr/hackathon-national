/**
 * OUTGOING API DEPENDENCIES — Adaptive Education OS
 *
 ...
 *
 * Criticality: critical. Uses `tryCall`, so if skills-opportunity is not
...
export async function fromSkillsOpportunityGaps(
  ...
  return ctx.platform.tryCall('skills-opportunity', 'GET /gaps', {
    ...options,
    relation: 'education -> skills-opportunity (GET /gaps)',
  });
}
