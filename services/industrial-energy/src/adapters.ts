/**
 * OUTGOING API DEPENDENCIES — Industrial & Energy Intelligence Grid
 *
...
// This ministry makes no synchronous cross-service calls; everything it needs arrives as events.
