# Examples — Justice Intelligence OS
...
curl "http://localhost:4000/api/justice/cases?limit=5"
curl "http://localhost:4000/api/justice/signals?limit=10"
curl http://localhost:4000/api/justice/dependencies
curl http://localhost:4000/api/justice/twins
```
...
curl -X POST http://localhost:4000/api/justice/cases \
...
curl http://localhost:4000/__platform/events | grep -A3 'justice.case.filed.v1'
...
curl http://localhost:4000/api/justice/openapi.json
```
