# Examples — Connected Health Intelligence System
...
curl "http://localhost:4000/api/health/facilities?limit=5"
curl "http://localhost:4000/api/health/signals?limit=10"
curl http://localhost:4000/api/health/dependencies
curl http://localhost:4000/api/health/twins
```
...
curl -X POST http://localhost:4000/api/health/facilities \
...
curl http://localhost:4000/__platform/events | grep -A3 'health.capacity.updated.v1'
...
curl http://localhost:4000/api/health/openapi.json
```
