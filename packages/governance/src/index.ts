/**
 * GOVERNANCE — RESERVED FOR PROMPT 02.
 *
 * Intellectual property, submission, club responsibilities.
 *
 ...
 * (@platform/governance), and the two shapes below so that wiring it in later
...
export function evaluate(_context: GovernanceContext): GovernanceDecision {
  return { allowed: true, reason: 'No governance are defined yet (reserved for Prompt 02).' };
}
